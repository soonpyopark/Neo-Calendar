...
/**
 * Hosts the hidden Neo-Desktop-Calendar.exe helper and queries icon hits over a named pipe.
...
function resolveHelperExe(): string | null {
  const candidates = [
    join(process.resourcesPath, 'desktop-hit-helper', 'Neo-Desktop-Calendar.exe'),
    join(app.getAppPath(), 'resources', 'desktop-hit-helper', 'Neo-Desktop-Calendar.exe'),
    join(
      app.getAppPath(),
      '..',
      '..',
    ...
    join(__dirname, '../../resources/desktop-hit-helper/Neo-Desktop-Calendar.exe'),
    join(__dirname, '../../../resources/desktop-hit-helper/Neo-Desktop-Calendar.exe')
  ]
